...
function LoginPage() {
  ...
  return (
    <div className='h-screen flex items-center justify-center p-4 sm:p-6 mb:p-8'>
      <div className='border border-primary/25 flex flex-col lg:flex-row w-full max-w-5xl mx-auto bg-base-100 rounded-xl shadow-lg overflow-hidden' data-theme="night">
              ...
              <div className='space-y-4'>
                <div>
                  ...
                  <p className='text-sm opacity-70'>
                    Sign in to your account to continue your language jouney
                  </p>
                </div>
